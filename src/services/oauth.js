export const generateOAuthUrl = (platformId) => {
  ...
  switch (platformId) {
    ...
    case 'threads':
      ...
      return `https://threads.net/oauth/authorize?client_id=${threadsClientId}&redirect_uri=${redirectUri}&scope=threads_basic,threads_content_publish,threads_manage_insights&response_type=code&state=${state}`;
