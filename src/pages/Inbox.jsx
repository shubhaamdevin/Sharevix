...
import { MessageSquare, Search, Send, Check, Phone, User, Info, MoreVertical, Star, ShieldAlert } from 'lucide-react';
...
export default function Inbox() {
  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '320px 1fr', height: 'calc(100vh - 80px)', background: 'var(--panel-bg)', borderRadius: '24px', border: '1px solid var(--panel-border)', overflow: 'hidden' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
          ...
          <div style={{ padding: '1rem 1.5rem', borderBottom: '1px solid var(--panel-border)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
              <img src={currentChat.avatar} alt={currentChat.name} style={{ width: '40px', height: '40px', borderRadius: '50%', objectFit: 'cover' }} />
              <div>
